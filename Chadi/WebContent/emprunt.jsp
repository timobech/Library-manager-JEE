                ...
                <div class="page-content">
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <div class="page-content">
								<h2>Emprunt Effectuée avec succès</h2>
								<h5>Veuillez se présenter a la Bibliothèque pour récupérer</h5>
								<a href="../index.jsp" class="btn btn-warning">Retour a l'accueil</a>
            </div>
